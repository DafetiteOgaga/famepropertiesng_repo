						...
						<div className="bg-light p-30 mb-5">
							<div className="row">
								...
								<div className="col-md-6 form-group">
									...
									<input className="form-control" type="text" placeholder="+234 806 000 1111"/>
								</div>
								{/* <div className="col-md-6 form-group">
								...
								<div className="col-md-6 form-group">
									<label>State</label>
									<input className="form-control" type="text" placeholder="Lagos"/>
								</div>
								<div className="col-md-6 form-group">
									<label>City</label>
									<input className="form-control" type="text" placeholder="Ajah"/>
								</div>
								{/* <div className="col-md-6 form-group">
