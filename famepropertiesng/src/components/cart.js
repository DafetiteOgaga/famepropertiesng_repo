...
function Cart() {
	return (
				...
				<div className="col-lg-6 text-center text-lg-right">
					...
					<div className="d-inline-flex align-items-center d-block d-lg-none">
						<a href="##" className="btn px-0 ml-2">
							...
							<span className="badge text-dark border border-dark rounded-circle cart-span-span">0</span>
						</a>
						<a href="##" className="btn px-0 ml-2">
		...
		<div className="container-fluid bg-dark mb-30">
			<div className="row px-xl-5">
				<div className="col-lg-3 d-none d-lg-block">
					<a className="btn d-flex align-items-center justify-content-between bg-primary w-100 anchor-a" data-toggle="collapse" href="#navbar-vertical">
						<h6 className="text-dark m-0"><i className="fa fa-bars mr-2"></i>Categories</h6>
						<i className="fa fa-angle-down text-dark"></i>
					</a>
					<nav className="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light cart-nav-v" id="navbar-vertical">
						...
						<div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
							<div className="navbar-nav mr-auto py-0">
								...
								<div className="nav-item dropdown">
									<a href="##" className="nav-link dropdown-toggle active" data-toggle="dropdown">Pages <i className="fa fa-angle-down mt-1"></i></a>
							...
							<div className="navbar-nav ml-auto py-0 d-none d-lg-block">
								<a href="##" className="btn px-0">
									...
									<span className="badge text-secondary border border-secondary rounded-circle cart-span-span">0</span>
								</a>
				...
				<div className="col-lg-8 table-responsive mb-5">
					<table className="table table-light table-borderless table-hover text-center mb-0">
						...
						<tbody className="align-middle">
							<tr>
								<td className="align-middle"><img src={getImage("product-1.jpg")} alt="" className="cart-image-img"/> Product Name</td>
							...
							<tr>
								<td className="align-middle"><img src={getImage("product-2.jpg")} alt="" className="cart-image-img"/> Product Name</td>
								<td className="align-middle">$150</td>
								<td className="align-middle">
									<div className="input-group quantity mx-auto cart-td-table">
										<div className="input-group-btn">
							...
							<tr>
								<td className="align-middle"><img src={getImage("product-3.jpg")} alt="" className="cart-image-img"/> Product Name</td>
								<td className="align-middle">$150</td>
								<td className="align-middle">
									<div className="input-group quantity mx-auto cart-td-table">
										<div className="input-group-btn">
							...
							<tr>
								<td className="align-middle"><img src={getImage("product-4.jpg")} alt="" className="cart-image-img"/> Product Name</td>
								<td className="align-middle">$150</td>
								<td className="align-middle">
									<div className="input-group quantity mx-auto cart-td-table">
										<div className="input-group-btn">
							...
							<tr>
								<td className="align-middle"><img src={getImage("product-5.jpg")} alt="" className="cart-image-img"/> Product Name</td>
								<td className="align-middle">$150</td>
								<td className="align-middle">
									<div className="input-group quantity mx-auto cart-td-table">
										<div className="input-group-btn">
		...
		<div className="container-fluid bg-dark text-secondary mt-5 pt-5">
			...
			<div className="row border-top mx-xl-5 py-4 cart-footer-div">
				...
				<div className="col-md-6 px-xl-0 text-center text-md-right">
					<img className="img-fluid" src={getImage("payments.png")} alt=""/>
				</div>
			</div>
		</div>
		{/* <!-- Footer End --> */}
